...
//Application Title
define('APP_TITLE', 'Maw ReDesign TinyFM');
...
$auth_users = array(
    'admin' => '$2y$10$GEV8LKUhaqgPP1c2oEni.u7bWImzRTwvWQYrzf/r9.xl4IBABYowi', //admin@123
    'user' => '$2y$10$GEV8LKUhaqgPP1c2oEni.u7bWImzRTwvWQYrzf/r9.xl4IBABYowi' //12345
);
                        ...
                        <div class="card fat" data-bs-theme="<?php echo FM_THEME; ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K Maw ReDesign TinyFM">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Maw ReDesign TinyFM <?php echo VERSION; ?></a></h3>
                        </p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Maw ReDesign TinyFM <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Maw ReDesign TinyFM <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Maw ReDesign TinyFM<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Maw ReDesign TinyFM">
        ...
        <style>
            body.fm-login-page {
                font-size: 14px;
                /* Mengganti warna dan pola lama dengan gradasi futuristik */
                background-color: #0f0c1d; /* Warna gelap untuk tema futuristik */
                background-image: 
                    radial-gradient(circle at 10% 20%, rgba(41, 128, 185, 0.15) 0%, transparent 20%),
                    radial-gradient(circle at 90% 80%, rgba(46, 204, 113, 0.15) 0%, transparent 20%),
                    radial-gradient(circle at 50% 50%, rgba(155, 89, 182, 0.1) 0%, transparent 30%),
                    /* Menambahkan pola grid futuristik */
                    linear-gradient(0deg, transparent 24%, rgba(255,255,255,.05) 25%, rgba(255,255,255,.05) 26%, transparent 27%, transparent 74%, rgba(255,255,255,.05) 75%, rgba(255,255,255,.05) 76%, transparent 77%, transparent),
                    linear-gradient(90deg, transparent 24%, rgba(255,255,255,.05) 25%, rgba(255,255,255,.05) 26%, transparent 27%, transparent 74%, rgba(255,255,255,.05) 75%, rgba(255,255,255,.05) 76%, transparent 77%, transparent);
                background-size: 
                    600px 600px, /* ukuran efek radial */
                    600px 600px,
                    600px 600px,
                    50px 50px, /* ukuran grid */
                    50px 50px;
                background-position: 
                    0 0,
                    0 0,
                    ...
                    0 0,
                    0 0;
                /* Menambahkan animasi latar belakang halus */
            ...
            .fm-login-page .card {
                border-color: rgba(255, 255, 255, 0.1); /* Warna border transparan futuristik */
                box-shadow: 
                    0 4px 20px rgba(0, 0, 0, 0.3),
                    0 0 0 1px rgba(255, 255, 255, 0.05), /* Glowing border ringan */
                    inset 0 0 15px rgba(255, 255, 255, 0.05); /* Efek cahaya dalam */
                background-color: rgba(30, 30, 46, 0.85); /* Warna card gelap transparan */
            ...
            .fm-login-page .card-title {
                ...
                font-size: 24px;
                font-weight: 400;
                color: #e0e0ff; /* Warna teks terang futuristik */
                text-shadow: 0 0 10px rgba(100, 100, 255, 0.3); /* Efek cahaya teks */
            }

            .fm-login-page .form-control {
                border-width: 2.3px;
                border-color: rgba(255, 255, 255, 0.2);
                background-color: rgba(20, 20, 35, 0.7); /* Latar form gelap */
            ...
            .fm-login-page .form-group label {
                width: 100%;
                color: #b0b0d6; /* Warna label terang */
            }

            .fm-login-page .btn.btn-block {
                padding: 12px 10px;
                background: linear-gradient(45deg, #3498db, #9b59b6); /* Gradient button */
                border: none;
                color: white;
                font-weight: bold;
                border-radius: 8px;
            ...
            .fm-login-page .footer {
                margin: 20px 0;
                color: #a0a0c0; /* Warna footer terang */
                text-align: center;
                font-size: 0.9em;
            }
            ...
            body.fm-login-page.theme-dark {
                /* Warna latar tema gelap tetap futuristik */
    ...
    *::after {
    ...
    body::before {
        ...
        background-image: 
            ...
            url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800"><defs><pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="rgba(100,200,255,0.1)" stroke-width="1"/></pattern></defs><rect width="100%" height="100%" fill="url(%23grid)"/></svg>');
    ...
    .nav-item.avatar .dropdown-menu a:hover {
    ...
    i.fa.fa-css3 {
        color: #f36fa0;
        filter: drop-shadow(0 0 3px rgba(243, 111, 160, 0.5));
    }
    ...
    i.fa.fa-html5 {
        color: #ff758f;
        filter: drop-shadow(0 0 3px rgba(255, 117, 143, 0.5));
    }
    ...
    .main-nav {
        padding: 0.2rem 1rem;
        box-shadow: 0 8px 32px rgba(0, 0, 0, 0.5);
        background: linear-gradient(135deg, rgba(15, 22, 40, 0.95), rgba(26, 29, 58, 0.95));
        backdrop-filter: blur(10px);
    ...
    hr.custom-hr {
        border-top: 1px dashed rgba(0, 217, 255, 0.3);
    ...
    #main-table span.badge:nth-child(5) {
        border-color: #b66dff;
        box-shadow: 0 0 10px rgba(182, 109, 255, 0.3);
    }
    ...
    .btn:focus {
        ...
        -webkit-box-shadow: 0 0 20px rgba(0, 217, 255, 0.5) !important;
    ...
    .table-hover>tbody>tr:hover>td:first-child {
        ...
        box-shadow: inset 5px 0 10px rgba(0, 217, 255, 0.2);
    }
    ...
    ::-webkit-scrollbar-thumb:hover {
        background: linear-gradient(180deg, #00e5ff, #00b4d8);
    }
    ...
    /* Modal styling */
    .modal-content {
        background: linear-gradient(135deg, rgba(15, 22, 40, 0.98), rgba(26, 29, 58, 0.98));
        border: 1px solid rgba(0, 217, 255, 0.3);
        border-radius: 10px;
    ...
    /* Tooltip styling */
    .tooltip-inner {
        background: linear-gradient(135deg, rgba(0, 217, 255, 0.95), rgba(0, 153, 204, 0.95));
    ...
    body::after {
        ...
        background-image: 
            ...
            radial-gradient(2px 2px at 60% 70%, rgba(0, 180, 216, 0.3), transparent),
    ...
    /* Glowing border animation for focused elements */
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Maw ReDesign TinyFM';
        $tr['en']['AppTitle']       = 'Maw ReDesign TinyFM';
        $tr['en']['Login']          = 'Sign in';
